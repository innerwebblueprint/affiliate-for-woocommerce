...
if ( ! class_exists( 'AFWC_Email_Commission_Paid' ) ) {
	...
	class AFWC_Email_Commission_Paid extends WC_Email {
		...
		public function trigger( $args = array() ) {
			...
			$this->email_args['show_invoice']          = is_callable( array( 'AFWC_Payout_Invoice', 'is_enabled_for_affiliate' ) ) && AFWC_Payout_Invoice::is_enabled_for_affiliate();
		...
		public function get_template_args() {
			return array(
				...
				'show_invoice'          => $this->email_args['show_invoice'],
