		...
		<div class="has-2-columns feature-section col two-col">
			...
			<div class="column col last-feature">
				<p align="right">
					...
					<a target="_blank" href="<?php echo esc_url( 'https://woocommerce.com/my-account/contact-support/?select=affiliate-for-woocommerce' ); ?>"><?php echo esc_html_x( 'Contact us', 'link to contact support', 'affiliate-for-woocommerce' ); ?></a>
				</p>
			</div>
		</div>
		...
		<div class="how-to">
			...
			<div class="has-2-columns feature-section col two-col">
				<div class="column col afw-faq">
					<ul>
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . '#section-5">' . esc_html__( 'How do I add/make a user an affiliate?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
						...
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . '#section-12">' . esc_html__( 'Where\'s the link an affiliate will use to refer to my site?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
						...
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . 'how-to-create-and-assign-coupons-to-affiliates/">' . esc_html__( 'How to give coupons for referral to affiliates?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
						...
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . 'how-to-assign-unassign-an-order-to-an-affiliate/">' . esc_html__( 'How to manually assign/unassign an order to an affiliate?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
				...
				<div class="column col last-feature afw-faq">
					<ul>
						...
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . 'how-to-set-different-affiliate-commission-rates-for-affiliates/">' . esc_html__( 'How to set different affiliate commission rates for affiliates?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . 'how-to-set-different-affiliate-commission-rates-for-affiliate-tags/">' . esc_html__( 'How to set different affiliate commission rates for affiliate tags?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
						<li><?php /* translators: Link to the Affiliate For WooCommerce Doc */ echo '<a target="_blank" href="' . esc_url( AFWC_DOC_DOMAIN ) . 'how-to-set-different-affiliate-commission-rates-for-product-or-product-category/">' . esc_html__( 'How to set different affiliate commission rates for product or product category?', 'affiliate-for-woocommerce' ) . '</a>'; ?></li>
